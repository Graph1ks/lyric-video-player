...
export const BUILTIN_PERFORMANCE_PRESETS: PerformancePresetDefinition[] = [
  ...
  },
  {
    ...
    auto: {
      ...
      backgrounds: ["prism-stage-beams", "spectrum", "rays", "aurora"],
  ...
  },
  {
    ...
    auto: {
      ...
      backgrounds: ["laser-canopy-grid", "sparks", "print", "architecture"],
  ...
  },
  {
    ...
    auto: {
      ...
      backgrounds: ["laser-canopy-grid", "vortex", "architecture", "grid"],
